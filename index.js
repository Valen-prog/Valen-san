...
{   
    ...
    */
    ...
    function fr(){
        ...
        message.channel.send(`Wished by <@718998542030733362>, <@402521092796710915>`,{embed: frembed}).then((msg)=> {msg.edit(`Wished by <@718998542030733362>, <@402521092796710915>`).react("❤"))}
